            ...
            <div class="col-md-5 ">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title" style="float: left";>Edit colis</h5>
                        <a href="{{ route('coliss') }}" class="btn btn-sm btn-primary" style="float: right;">Liste des colis</a>
                    </div>
                    <div class="card-body">
                        @if (session()->has('message'))
                            <div class="alert alert-success text-center">{{ session('message') }}</div>
                        @endif
                        <form wire:submit.prevent="updateColis">
